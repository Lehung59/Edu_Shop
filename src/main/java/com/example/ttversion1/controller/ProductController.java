...
public class ProductController {
    ...
    @GetMapping(value = "/product/delete/{productname}")
    ...
    @GetMapping(value = "/product/status-1/{productname}")
    ...
    @GetMapping(value = "/product/status-2/{productname}")
    ...
    @GetMapping(value = "/product/status-3/{productname}")
